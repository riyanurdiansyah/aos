...
class _$_Product implements _Product {
  const _$_Product(
      ...
      this.errorMessage = "",
      final List<DataProduct> data = const []})
      : _data = data;
  ...
  @override
  String toString() {
    return 'Product(success: $success, message: $message, errorMessage: $errorMessage, data: $data)';
  }
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      final String errorMessage,
      final List<DataProduct> data}) = _$_Product;
